                ...
                <div class="col-lg-12">
                  <div class="more-info">
                    <div class="row d-flex justify-content-start">
                      <div class="col-2">
                        <h4><span>신장:</span><br><span id="my-height" style="color :#22B3C1; font-size: 20px; font-weight: 700;">${surveyDto.height } cm</span></h4>
                      </div>
                      <div class="col-2">
                        <h4><span>몸무게:</span><br><span id="my-weight" style="color :#22B3C1; font-size: 20px; font-weight: 700;">${surveyDto.weight }kg</span></h4>
                      </div>
                      <div class="col-2">
                        <h4><span>체질량지수(BMI):</span><br><span id="my-bmi" style="color :#22B3C1; font-size: 20px; font-weight: 700;"><fmt:formatNumber value="${bmi }" type="number" pattern=".00"/></span></h4>
                      </div>
                      <div class="col-6 align-self-center text-start">
                        <div class="w-100">
                          <div class="progress">
                            <div class="progress-bar" role="progressbar">
                              <span class="bmi-span">저체중</span>
                              <span class="line"></span>
                              <span>~18.5</span>
                            </div>
                            <div class="progress-bar" role="progressbar">
                              <span class="bmi-span on">정상</span>
                              <span class="line"></span>
                              <span>~24.9</span>
                            </div>
                            <div class="progress-bar" role="progressbar">
                              <span class="bmi-span">과체중</span>
                              <span class="line"></span>
                              <span>~29.9</span>
                            </div>
                            <div class="progress-bar" role="progressbar">
                              <span class="bmi-span">비만</span>
                              <span class="line"></span>
                              <span>~34.9</span>
                            </div>
                            <div class="progress-bar" role="progressbar">
                              <span class="bmi-span">고도비만</span>
                              <span class="line"></span>
                              <span>35~</span>
                            </div>
                          </div>
		                ...
		                <div class="item">
		                  <div class="row row-shadow">
		                    <div class="col-lg-3 align-self-center">
		                      <img src="/assets/images/pill/오메가3-3.PNG" alt="">
		                    </div>
		                      ...
		                      <div class="h-100 p-3 mb-5">
		                        <div class="right-content p-5 h-100">
		                          <div class="d-flex justify-content-between mb-3">
		                            ...
		                            <button type="button" class="btn opacity-75">상세보기</button>              
		                          </div>
		                          ...
		                          <div class="mt-5 d-flex justify-content-between">
		                            <div>
		                              ...
		                              <span class="d-inline" id="user-percentage">
		                                비슷한 연령대의 남성들중 5천명의 추천을 받았어요
		                              </span>
		                            </div>
		                            <div>
		                              <i class="fa fa-globe"></i>
		                              <span class="d-inline" id="user-percent">
		                                전체 설문조사에서 30%의 추천을 받았어요
		                              </span>
		                            </div>
		                          </div>
		                        </div>
