 ...
 <c:set var="wishList" value="${sessionScope.wishList}" />
    ...
    <div class="myPage-left-header">
        <div class="profile-area">
            <div class="profile-inner">
                <a href="#">
                    <div class="profile">
                        <img src="/assets/images/withpill-basic-profile.jpg" alt="위드필 기본 프로필 이미지" />
                        ...
                        <form name="myAccountForm" method="post">
	                        ...
	                        <ul class="myinfo-area">
	                            ...
	                            <li>
	                                <div class="myaccount">
	                                    <div class="myname">
	                                        <p><input type="text" value="${accountList.name}" name="name" readonly/></p>
	                                    </div>
	                                    <div class="mypw">
	                                        <p>
	                                    ...
	                                    <div class="myaddress"><p><input type="text" value="${accountList.email}" name="email" readonly/></p></div>
	                                    <div class="myphone">
	                                        <p><input type="text" value="${accountList.phone}" name="phone" readonly/></p>
	                                    </div>
	                                </div>
	                            </li>
	                        </ul>
  ...
  <script>
    ...
    function edit(password){
		...
		if( pw == password ){
			$("input[name='name'], input[name='email'], input[name='phone'], input[name='password']").removeAttr("readonly");
		}else{
			// 회원정보 수정 불가
			alert("비밀번호를 확인해 주세요!");
		}    	
