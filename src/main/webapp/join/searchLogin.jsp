          ...
          <form id="findpw-form" name="findpwform"  action="/searchPw"method="post">
            <div class="row">
              ...
              <div class="col-lg-12">
                  ...
                  <div>
						      성별 : <label>남성<input type="radio" name="genderId" value="1"checked></label> 
						      <label>여성<input type="radio"name="genderId" value="2"></label>
					        </div>
              ...
              <div class="col-lg-12">                        
                <fieldset>
                  <button class="main-button"></a>임시 비밀번호 발송</button>                  
                </fieldset>
              </div>
